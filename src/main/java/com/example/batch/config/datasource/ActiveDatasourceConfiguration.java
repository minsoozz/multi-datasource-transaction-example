...
@EnableJpaRepositories(
        basePackages = "com.example.batch.active",
        entityManagerFactoryRef = "activeEntityManager",
        transactionManagerRef = "activeTransactionManager"
)
public class ActiveDatasourceConfiguration {

    @Primary
    @Bean
    @ConfigurationProperties("spring.datasource.hikari")
    public DataSource activeDatasourceProperties() {
    ...
    public LocalContainerEntityManagerFactoryBean activeEntityManager() {
        ...
        em.setDataSource(activeDatasourceProperties());
        em.setPackagesToScan("com.example.batch.active");
